...
====================================
[+]Tools  Multiple BF Instagram [+]
-----Creator Tools : JExCoders-----
       --Design by : ./Silent7--
---------instagran : @silen7.id_---
====================================" | lolcat
...
#menu
echo -e '''
1]. Get target from specific \e[1;33m@username\e[1;37m
2]. Get target from specific \e[1;33m#hashtag\e[1;37m
